...
import { ArrowLeft, Layers, Globe, RefreshCw, Shield, CheckCircle2 } from "lucide-react";
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          >
            ...
            <div className="flex items-center justify-center gap-4 flex-wrap">
              <Link to="/dashboard">
                <Button size="lg" className="gradient-brand text-primary-foreground border-0">
                  Rozpocznij za darmo
                </Button>
              </Link>
              <Link to="/#ecosystem">
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto max-w-6xl">
            ...
            <p className="text-muted-foreground text-center mb-12 max-w-md mx-auto">
              Wszystko, czego potrzebujesz, w jednym module.
            </p>
            <motion.div
              initial="hidden"
              whileInView="show"
      ...
      {mod.useCases.length > 0 && (
        <section className="py-20 px-4">
          <div className="container mx-auto max-w-5xl">
            ...
            <p className="text-muted-foreground text-center mb-12 max-w-md mx-auto">
              Rozwiązania dopasowane do każdego użytkownika.
            </p>
          ...
          <div className="container mx-auto max-w-4xl">
            ...
            >
              ...
              <h2 className="font-display text-2xl md:text-3xl font-bold mb-3">
                Pełna integracja z <span className="gradient-brand-text">Ekosystemem DOMIO</span>
              </h2>
              <p className="text-muted-foreground mb-8 max-w-lg mx-auto">
                Jeden login, jedno konto — wszystkie moduły połączone w spójny ekosystem.
              </p>
        ...
        <div className="container mx-auto max-w-3xl text-center">
          ...
          >
            ...
            <p className="text-muted-foreground mb-8">
              Zacznij korzystać już dziś — bez zobowiązań.
            </p>
            <Link to="/dashboard">
              <Button size="lg" className="gradient-brand text-primary-foreground border-0">
                Rozpocznij za darmo
